...
<body>
			...
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form" >
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="username" placeholder="Enter email" id="username">
					...
					<div class="container-login100-form-btn" align="right">
						...
						<a style="text-align:right; display:inline; margin-left:50px; margin-top:15px;" href=".\login-ui\forgot.html" > Forgot password?</a>
					</div>
    ...
    $("#loginBtn").on("click", function () {
        ...
        $.ajax({
            type: "POST",
            url: "./login-ui/process_login.php",
            data: {
                username: username,
            },
